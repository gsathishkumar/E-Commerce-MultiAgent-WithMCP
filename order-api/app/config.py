...
class Settings(BaseSettings):
    ...
    # Application
    # ------------------------------------------------------------------
    app_name: str = Field(default="Orders API", description="OpenAPI service title.")
    ...
    # API
    # ------------------------------------------------------------------
    api_v1_prefix: str = Field(default="/order-api/api/v1", description="URL prefix for v1 routes.")
    ...
    mongo_db_user: str = "admin_user_name_here"
    mongo_db_password: str = "admin_password_here"
    ...
    mongo_db_name: str = Field(default="orders_db", description="MongoDB database name.")
    mongo_orders_collection: str = Field(
        default="orders",
        description="Collection storing order documents (with embedded tracking_updates).",
    )
