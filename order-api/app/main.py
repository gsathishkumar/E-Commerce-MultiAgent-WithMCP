...
app = FastAPI(
    ...
    description=(
        "FastAPI service exposing order details and tracking history "
        "from MongoDB.\n\n"
        "**Layers:** Routes → Services → Tools → MongoDB `orders` collection"
    ),
...
async def show_settings():
    ...
    return {
        ...
        "mongo_orders_collection": settings.mongo_orders_collection,
